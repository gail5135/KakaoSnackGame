...
playGame.prototype = {
    create: function(){
        ...
        // Add Class
        classSet = game.add.sprite(game.width / 2, game.height-50, "classSet");
        classSet.anchor.set(0.5);
